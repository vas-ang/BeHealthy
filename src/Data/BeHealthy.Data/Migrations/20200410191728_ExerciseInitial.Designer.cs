...
namespace BeHealthy.Data.Migrations
{
    ...
    [Migration("20200410191728_ExerciseInitial")]
    partial class ExerciseInitial
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeHealthy.Data.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("BeHealthy.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BeHealthy.Data.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BeHealthy.Data.Models.Exercise", b =>
                {
                    b.HasOne("BeHealthy.Data.Models.ApplicationUser", "Creator")
            ...
            modelBuilder.Entity("BeHealthy.Data.Models.ExerciseStep", b =>
                {
                    ...
                    b.HasOne("BeHealthy.Data.Models.ExerciseStep", "Next")
                        .WithOne()
                        .HasForeignKey("BeHealthy.Data.Models.ExerciseStep", "NextId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BeHealthy.Data.Models.ExerciseStep", "Previous")
                        .WithOne()
                        .HasForeignKey("BeHealthy.Data.Models.ExerciseStep", "PreviousId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("BeHealthy.Data.Models.ExerciseTag", b =>
                {
                    ...
                    b.HasOne("BeHealthy.Data.Models.Tag", "Tag")
                        .WithMany("ExerciseTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("BeHealthy.Data.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BeHealthy.Data.Models.ApplicationUser", null)
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
