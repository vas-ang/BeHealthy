namespace BeHealthy.Services.Data.Tests
{
    ...
    using BeHealthy.Services.Data.Tests.Models.ExerciseSteps;
    using BeHealthy.Services.Mapping;
    using Microsoft.EntityFrameworkCore;
    using Xunit;

    public class ExerciseStepsServiceTests
    {
        ...
        private readonly ExerciseStepsService exerciseStepService;

        public ExerciseStepsServiceTests()
        {
            ...
            this.exerciseStepService = new ExerciseStepsService(this.exerciseStepRepository);
