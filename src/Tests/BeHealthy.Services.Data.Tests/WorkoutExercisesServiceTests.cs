namespace BeHealthy.Services.Data.Tests
{
    ...
    using BeHealthy.Services.Data.Tests.Models.WorkoutExercises;
    using BeHealthy.Services.Data.WorkoutExercises;
    using BeHealthy.Services.Mapping;
    using Microsoft.EntityFrameworkCore;
    using Xunit;

    public class WorkoutExercisesServiceTests
    {
        private readonly ApplicationDbContext db;
        private readonly EfRepository<WorkoutExercise> workoutExerciseRepository;
        private readonly WorkoutExercisesService workoutExerciseService;

        public WorkoutExercisesServiceTests()
        {
            ...
            this.workoutExerciseService = new WorkoutExercisesService(this.workoutExerciseRepository);
